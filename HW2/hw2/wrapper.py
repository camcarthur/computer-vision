...
def part1() -> None:
    ...
    """
    #
    tl_images = ['images/background_img_tl_red_bright.jpg',
                 'images/tl_all_bright_default.jpg',
                 'images/tl_green_bright_default.jpg',
                 'images/tl_red_bright_default.jpg',
                 'images/tl_yellow_bright_default.jpg',
                 'images/background_img_tl_red_bright2.jpg',
                 'images/background_img_tl_green_bright.jpg',
...
def part3() -> None:
    sign_images = ['images/construction_warning_rr_crossing_background02.jpg',
                   'images/all_signs_blank_background.jpg', 'images/all_signs.jpg',
                   'images/construction_warning_rr_crossing_background.jpg',
    ...
    for img_in, file_out in zip(sign_images, file_name):
        ...
        # print(found_signs)
        if found_signs is not None and found_signs.size > 0:
